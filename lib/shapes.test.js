...
describe("Square", function() {
    ...
    it("renders blue square with red text 'Tru'", function() {
        const square = new Square("Tru", "red", "blue");
        const data = square.render();
        // console.log("the square is: ", data);
        expect(data).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
            <rect width="150" height="150" x="80" y="35" fill="blue" />
            <text x="150" y="125" font-size="60" text-anchor="middle" fill="red">Tru</text>
            </svg>`);
    });
});